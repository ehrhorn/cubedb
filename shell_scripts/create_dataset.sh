...
then
    ...
    singularity run --no-home -H /home/icecube -B $HOME/data:/home/icecube/data,$HOME/work:/home/icecube/work,/groups/icecube/stuttard/data:/groups/icecube/stuttard/data \
        ...
        python -u /home/icecube/work/cubedb/cubedb/create_sql_db.py -n $1 -q /home/icecube/work/cubedb/candidate_events.sql -r 1
    singularity run --no-home -H /home/icecube -B $HOME/data:/home/icecube/data,$HOME/work:/home/icecube/work,/groups/icecube/stuttard/data:/groups/icecube/stuttard/data \
        docker://ehrhorn/cubedb:0.1 \
        python -u /home/icecube/work/cubedb/cubedb/create_dataset.py -n $1
else
